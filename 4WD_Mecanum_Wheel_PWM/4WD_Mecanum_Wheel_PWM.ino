...
void loop() 
{
  ...
  if( rJoyX >= pss_val_low_low && rJoyX <= pss_val_low_high )
  {
   ...
   digitalWrite(motor_1PWM,motor_Front_left_speed);
   digitalWrite(motor_2PWM,motor_Front_right_speed);
   digitalWrite(motor_3PWM,motor_Back_left_speed);
   digitalWrite(motor_4PWM,motor_Back_right_speed);
  }
  ...
  {  
   ...
   motor_Back_right_speed  = map(lJoyY,140 , 255, 0 , 255);
   ...
   digitalWrite(motor_2PWM,motor_Front_right_speed);
   digitalWrite(motor_3PWM,motor_Back_left_speed);
   digitalWrite(motor_4PWM,motor_Back_left_speed);
  }
  else if( lJoyY >= pss_val_low_low && lJoyY <= pss_val_low_high ) 
  {
   ...
   motor_Back_right_speed  = map( lJoyY, 120, 0, 0, 255);
